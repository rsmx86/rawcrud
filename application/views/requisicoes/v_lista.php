            ...
            <table width="100%" border="0" cellspacing="5">
                <tr>
                    <td width="25%">
                        ...
                        <input type="text" name="lote" value="<?= $this->input->get('lote') ?>" style="width:100%" placeholder="Search lote...">
                    </td>
                    <td width="25%">
                        ...
                        <select name="cliente" style="width:100%">
                            ...
                            <?php foreach($clientes as $c): ?>
                                <option value="<?= $c->id ?>" <?= $this->input->get('cliente') == $c->id ? 'selected' : '' ?>>
                    ...
                    <td width="20%">
                        ...
                        <input type="date" name="data_inicio" value="<?= $this->input->get('data_inicio') ?>" style="width:100%">
                    </td>
                    <td width="20%">
                        <span class="filter-label">TO_DATE:</span>
                        <input type="date" name="data_fim" value="<?= $this->input->get('data_fim') ?>" style="width:100%">
                    </td>
                    <td width="10%" align="right" valign="bottom">
                        ...
                        <button type="button" onclick="window.location.href='<?= site_url('requisicoes') ?>'" style="width:100%; background:#800000; color:#FFF; font-size:10px; height:20px; margin-top:2px; cursor:pointer;"><b>[CLR]</b></button>
                    </td>
                </tr>
            </table>
        </form>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr>
                        <td>
                            ...
                            <button onclick="window.location.href='<?= site_url('devolucao'); ?>'" style="background-color:#FFD700;"><b>[ RETURNS_DEVOLUCAO ]</b></button>
                        </td>
                    </tr>
                </table>
                        ...
                        <?php if(!empty($requisicoes)): ?>
                            ...
                            <tr>
                                ...
                                <td align="center" bgcolor="#FFFFE1">
                                    <font face="Courier New" size="2"><b><?= $r->codigo_despacho ? $r->codigo_despacho : '------'; ?></b></font>
                                </td>
