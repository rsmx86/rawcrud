        ...
        <td bgcolor="#D6D2C4" style="padding:10px;">
                ...
                <tbody>
                    <?php if(!empty($estoque)): ?>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <font face="Arial" size="2"><?= strtoupper($e->lote) ?></font>
                            </td>
                            
                            <td align="right" bgcolor="#E8FFE8">
                                <font face="Arial" size="2"><b><?= number_format($e->saldo_disponivel, 0, '', '.') ?></b></font>
                            </td>
                            
                            <td align="center">
                                <font face="Arial" size="1" color="<?= ($e->status_posicao == 'ACTIVE') ? 'green' : 'red' ?>">
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <td align="right">
                        <font face="Arial" size="1"><b>TOTAL DE LINHAS NO INVENTÁRIO: <?= count($estoque) ?></b></font>
                    </td>
                </tr>
            </table>
